 ...
 */
public class getTudo extends AsyncTask<String,String,String> {
    Context context;
    ListView listView;
    String data = "";
    String res = "";
    public getTudo(Context context, ListView listView, String data)
    {
    ...
    protected String doInBackground(String... string) {
        try {
            URL url = new URL("http://easymarket.pe.hu/listTudo.php");
